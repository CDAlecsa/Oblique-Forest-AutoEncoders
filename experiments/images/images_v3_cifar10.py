...
#                               Function
###################################################################################################
def run_images_v3_cifar10(folder, folder_plots, filename):
...
path_results = general_path + "images_v3_cifar10/"
path_name_plots = "plots/" 

filename_results = "images_v3_cifar10"

makedir(path_results, True)
makedir(path_results + path_name_plots, False)

run_images_v3_cifar10(path_results, path_name_plots, filename_results)
